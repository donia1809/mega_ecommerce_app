...
abstract class CartRepository {
  ...
  Future<Either<Failure, CartEntity>> removeFromCart(String cartId);
  // Future<Either<Failure, CartEntity>> increaseQuantity(String cartId);
  // Future<Either<Failure, CartEntity>> decreaseQuantity(String cartId);
}
