  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Text(
          '''
Welcome to Mega.By accessing or using our application or website, you agree to be bound by these Terms & Conditions. If you do not agree, please do not use our services. 
1. Definitions
“App” refers to [Your App Name].
